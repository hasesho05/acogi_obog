                ...
                <div className="bg-white/80 backdrop-blur rounded-2xl p-6 shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-lg font-semibold text-secondary mb-2">2025年10月12日(日)</p>
                      <p className="text-xs md:text-sm text-gray-600">11:00 開場 / 11:30 開演</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4 sr-stagger">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs md:text-sm text-gray-600 mt-1">ウェルカムドリンクでお出迎え</p>
                  </div>
                </div>

                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-20 text-right">
                    <span className="text-xs md:text-sm font-semibold text-secondary">11:30</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-dark">第1部 演奏会</p>
                    <p className="text-xs md:text-sm text-gray-600 mt-1">ソロ・デュエット・バンド演奏など</p>
                  </div>
                </div>

                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-20 text-right">
                    <span className="text-xs md:text-sm font-semibold text-secondary">12:30</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-dark">休憩・交流タイム</p>
                    <p className="text-xs md:text-sm text-gray-600 mt-1">軽食を楽しみながら音楽談義</p>
                  </div>
                </div>

                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-20 text-right">
                    <span className="text-xs md:text-sm font-semibold text-secondary">13:00</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-dark">第2部 演奏会</p>
                    <p className="text-xs md:text-sm text-gray-600 mt-1">様々なジャンルの演奏をお楽しみください</p>
                  </div>
                </div>

                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 w-20 text-right">
                    <span className="text-xs md:text-sm font-semibold text-secondary">15:00</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-dark">終演</p>
                    <p className="text-xs md:text-sm text-gray-600 mt-1">全体写真撮影・次回のお知らせ</p>
                  </div>
                </div>
              </div>
            </div>
